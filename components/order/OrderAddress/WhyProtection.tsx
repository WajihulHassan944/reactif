...
const WhyProtection = () => {
  return (
      <div className="w-full max-w-6xl flex flex-col md:flex-row gap-10 p-10 bg-neutral-800/80 rounded-3xl outline outline-1 outline-offset-[-1px] outline-neutral-50/30">

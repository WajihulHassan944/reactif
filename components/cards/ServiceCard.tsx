...
export default function ServiceCard({
  ...
  return (
    <div
      className={`w-full p-10 bg-neutral-900/80 rounded-xl border 
      ${popular ? "border-pink-400 shadow-[0px_0px_20px_rgba(242,98,181,0.5)]" : "border-stone-500/50"}
    ...
    >
      ...
      <div className="flex flex-col gap-8">
        <div>
          <h3 className="text-3xl font-bold text-neutral-50 font-inter">
            {title}
          </h3>
          ...
          <div className="flex flex-wrap gap-2 mt-4">
            {features.map((feature, index) => (
              <div
                key={index}
                className="px-2.5 py-1 rounded border border-stone-500/50 flex items-center gap-1 text-xs text-stone-300"
              >
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-2xl font-bold text-neutral-50 font-hk">
            $ {price}
          </p>
        </div>
